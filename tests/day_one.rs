...
mod tests {
    ...
    fn get_required_fuel_for_module_mass_success() {
        use aoc2019::day_one::get_required_fuel_for_module_mass;
    ...
    fn get_total_fuel_for_module_masses_success() {
        use aoc2019::day_one::get_total_fuel_for_module_masses;
    ...
    fn get_required_fuel_for_module_mass_two_success() {
        use aoc2019::day_one::get_required_fuel_for_module_mass_two;
        let expected_module_one_fuel = 2.0;
    ...
    fn day_one_part_two_solution() {
        use aoc2019::day_one::get_total_fuel_for_module_masses_two;
        use std::fs::File;
        use std::io::Read;
